function draw_generictimer(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	if (mode == 0)
	{
	    if (overtime)
	    {
	        ...
	        draw_text((xoffset+xsize/2)+xshift,yoffset+30+yshift,string_hash_to_newline("OVERTIME"));
	    }
	    else
	    {
	        ...
	        draw_text_transformed(xoffset+xsize/2+20, yoffset+timeYOff, string_hash_to_newline(format_timer_value(ticks)), 1, 1, 0);
	        draw_set_font(global.gg2Font);
        
	        if(isControlPointSetup)
	        {
	            draw_set_halign(fa_center);
	            draw_text_transformed(xoffset+xsize/2-3, yoffset+40,string_hash_to_newline("Setup"),1,1,0);
	        }
	    }
	}
	else
	{
	    ...
	    {
	        draw_set_halign(fa_center);
	        draw_text(xoffset+xsize/2,yoffset+2,string_hash_to_newline("OVERTIME"));
	    }
	    else
	    {
	        draw_set_halign(fa_right);
	        draw_set_font(global.timerFont);
	        draw_text_transformed(xoffset+xsize/2+24, yoffset+2, string_hash_to_newline(format_timer_value(countdown)), 1, 1, 0);
	        draw_set_font(global.gg2Font);
	    }
	}
